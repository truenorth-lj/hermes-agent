...
metadata:
  hermes:
    tags: [security, defi, smart-contract, risk-analysis, crypto, blockchain]
    category: security
prerequisites:
  commands: [curl, jq]
  optional_commands: [solana]
---
...
Real-world examples: 79 audit reports covering DeFiLlama top 100 protocols and all major perp exchanges are published at <https://github.com/truenorth-lj/crypto-project-security-skill/tree/main/docs/examples> (12 CRITICAL, 22 HIGH, 38 MEDIUM, 7 LOW).
